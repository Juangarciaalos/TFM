...
def get_config_title(config_name: str) -> str:
    ...
    mapping = {
        ...
        "sdpa": "SDPA",
        "sdpa_opt": "SDPA + AMP+CKPT",
        "sdpa_snapshot": "SDPA Snapshot",
        "sdpa_opt_snapshot": "SDPA + AMP+CKPT Snapshot",
    }
...
def generate_individual_plots(args) -> None:
    """
    Genera las gráficas de memoria para una ejecución de GPT-2.
